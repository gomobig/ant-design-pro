export default {
  ...
  'login.rule.role': 'Please choice your role！',
  ...
  'password-change.label.confirm': 'Confirm Password',
  'password-change.button.save': 'Save',
  'password-change.rule.confirm': 'Two passwords that you enter is inconsistent!',
  ...
  'label.time': 'Range',
  'search.input.name.upload': 'Input name or upload picture',
  'search.select.match.highest': 'Highest',
  'search.select.match.higher': 'Higher',
  'search.select.match.general': 'General',
  'search.select.match.lower': 'Lower',
  'search.select.age.old': 'Old',
  'search.select.age.middle_aged': 'Middle',
  'search.select.age.young': 'Young',
  'search.select.age.childhood': 'Childhood',
  'search.select.gender.male': 'Male',
  'search.select.gender.female': 'Female',
  'search.select.glasses.with': 'With Glasses',
  'search.select.glasses.none': 'No Glasses',
  'search.select.match.placeholder': 'Similarity',
  'search.select.age.placeholder': 'Age',
  'search.select.gender.placeholder': 'Gender',
