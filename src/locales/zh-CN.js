export default {
  ...
  'project.name': '智慧安防',
  'login.role': '身份',
  'login.rule.account': '请输入用户名！',
  'login.rule.password': '请输入密码！',
  'login.rule.role': '请选择身份！',
  ...
  'password-change.label.confirm': '确认密码',
  'password-change.button.save': '保存',
  'password-change.rule.confirm': '两次密码不一致！',
  'password-change.rule.old-password.require': '请输入旧密码！',
  'password-change.rule.new-password.require': '请输入新密码！',
  'password-change.rule.confirm.require': '请再输入一次新密码！',
  'password-change.rule.confirm.error': '密码至少位6位字符 支持英文和数字！',
  'password-change.rule.old-password.error': '原始密码错误！',
  'password-change.rule.old-new-same.error': '新旧密码不能一样！',
  'label.time': '时间',
  'search.input.name.upload': '输入姓名或上传图片',
  'search.select.match.highest': '极高',
  'search.select.match.higher': '较高',
  'search.select.match.general': '一般',
  'search.select.match.lower': '较低',
  'search.select.age.old': '老年',
  'search.select.age.middle_aged': '中年',
  'search.select.age.young': '青年',
  'search.select.age.childhood': '幼年',
  'search.select.gender.male': '男士',
  'search.select.gender.female': '女士',
  'search.select.glasses.with': '戴眼镜',
  'search.select.glasses.none': '不戴眼镜',
  'search.select.match.placeholder': '相似度',
  'search.select.age.placeholder': '年龄',
